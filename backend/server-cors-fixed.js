...
// Security middleware with relaxed COOP for Firebase Auth
app.use(helmet({
...
app.post('/api/photos/upload', upload.single('photo'), async (req, res) => {
  try {
    ...
    // Create mock image URL (in real app, this would be uploaded to S3/Firebase)
    const mockImageUrl = req.file
      ? `https://images.pexels.com/photos/8499625/pexels-photo-8499625.jpeg?auto=compress&cs=tinysrgb&w=800`
      : 'https://images.pexels.com/photos/8499625/pexels-photo-8499625.jpeg?auto=compress&cs=tinysrgb&w=800';
...
app.listen(PORT, () => {
  ...
  console.log(`📁 File uploads: Enabled (multipart/form-data)`);
  console.log(`🔒 COOP policy: same-origin-allow-popups (for Firebase Auth)`);
});
